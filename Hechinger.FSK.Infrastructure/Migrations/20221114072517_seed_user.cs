...
namespace Hechinger.FSK.Infrastructure.Migrations
{
    public partial class seed_user : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            values: new object[,]
            {
                { 0, DateTime.Now, "SYSTEM",DateTime.Now, "SYSTEM", (int)EntityStatuses.InActive,"0000", "-", "-", "","", true, DateTime.Now.AddHours(2),DateTime.Now, 2,1,25},
        ...
        {
            migrationBuilder.Sql("Delete Users where Id = 1");
        }
    }
}
