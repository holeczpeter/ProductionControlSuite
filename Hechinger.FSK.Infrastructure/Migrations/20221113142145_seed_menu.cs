        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
             ...
             values: new object[,]
             {
                    ...
                    { 27, DateTime.Now, "SYSTEM",DateTime.Now, "SYSTEM", (int)EntityStatuses.Active,  (int)MenuTypes.SubMenu, "Törzsadatok importálása", "Törzsadatok importálása","Import", "upload", 3, 21, "/admin/import"},
             });
        }
