    ...
    public partial class seed_menu : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            values: new object[,]
            {
                    ...
                    { 4, DateTime.Now, "SYSTEM",DateTime.Now, "SYSTEM", (int)EntityStatuses.Active,  (int)MenuTypes.SubMenu, "Hibagyújtő felvitele", "Hibagyűjtők felvitele","Neue Fehlersammelkarte", "add", 1, 3, "/defect-card/add"},
                    ...
                    { 8, DateTime.Now, "SYSTEM",DateTime.Now, "SYSTEM", (int)EntityStatuses.Active,  (int)MenuTypes.SubMenu,"Éves összegzés", "Éves összegzés","Qualitätsverlauf monatlich", "bar_chart", 1, 7, "/report/quality-history-monthly"},
                    ...
                    { 12, DateTime.Now, "SYSTEM",DateTime.Now, "SYSTEM", (int)EntityStatuses.Active,  (int)MenuTypes.SubMenu,"Műhelyek", "Műhelyek","Werkstätte", "group_work", 2, 10, "/basic-data/workshop"},
