...
export class ProductContextService {
  ...
  addOperation(operation: OperationContext | null) {
    ...
    operations.push(this.formBuilder.group({
      ...
      order: [operation ? operation.order : '',  [Validators.required, Validators.min(1)]],
      norma: [operation ? operation.norma : 0, [Validators.min(0)]],
      ppmGoal: [operation ? operation.ppmGoal : 0, [Validators.min(0)]],
      operationTime: [operation ? operation.operationTime : 0, [Validators.required, Validators.min(0)]],
  ...
  addDefect(defect: DefectContext | null, opIndex: number) {
    ...
    defects.push(this.formBuilder.group({
      ...
      order: [defect ? defect.order : '', [Validators.required, Validators.min(1)]],
